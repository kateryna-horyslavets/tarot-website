...
import AFTER_BACKGROUND_IMG from '../assets/images/after tarot page/after_in_works_background.png';
import GROUP_AFTER from '../assets/images/after tarot page/Group_after_in_works.png';

export default function AfterTarotPage() {
    ...
    return (
        <div
            ...
            style={{ backgroundImage: `url(${AFTER_BACKGROUND_IMG})` }}
        >

            <div className="flex flex-col items-center lg:items-start z-10 max-w-lg text-center lg:text-left pt-20 -ml-8">
                <h1 className="text-7xl font-montserrat font-bold text-cyan-800/80 drop-shadow-[4px_3px_0px_rgba(0,0,0,0.2)] pb-8">
                    {t.title}
                </h1>

                <Link
                    to="/"
                    className="px-8 py-3 bg-cyan-50 text-cyan-800 font-montserrat font-bold rounded-3xl hover:bg-cyan-100 drop-shadow-[3px_3px_2px_rgba(0,0,0,0.3)]"
                >
                    {t.button}
                </Link>
            </div>
